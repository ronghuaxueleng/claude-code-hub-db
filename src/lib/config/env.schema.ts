...
export const EnvSchema = z.object({
  ...
  MAX_RETRY_ATTEMPTS_DEFAULT: z.coerce
    ...
    .default(2),
  // Fetch 超时配置（毫秒）
  FETCH_BODY_TIMEOUT: z.coerce.number().default(1800_000), // 请求/响应体传输超时（默认 1800 秒 = 30 分钟）
  FETCH_HEADERS_TIMEOUT: z.coerce.number().default(1800_000), // 响应头接收超时（默认 1800 秒 = 30 分钟）
